...
//> Default
let res = 'https://api-frteam.my.id/'
let api = '?&apikey=gamanaufal'
//--------------------------------
...
case 'ahegao':
	    ...
	    if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwahegao' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
          break
...
case 'anal':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwanal' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
           break
...
case 'ass':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwnsfwass' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'cums':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwcum' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'ecchi':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwecchi' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'ero':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwero' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'feet':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwfeet' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'holoero':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwholoero' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'holo':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwholo' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'eroyuri':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfweroyuri' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'femdom':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwfemdom' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'futanari':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwfutanari' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'hentai':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwhentai' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'kuni':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwkuni' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'loli':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwloli' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'manga':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwmanga' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'milf':
         ...
         if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwmilf' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'mstrb':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwmasturbation' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'panties':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwpanties' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'pussy':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwpussy' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'tentacles':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwtentacles' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'tits':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwtits' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'thighs':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwthighs' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'yaoi':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwyaoi' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'yuri':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'nsfwyuri' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
