...
const listMessage = {
  text: tek,
  footer: 'ʟᴀᴘᴏʀᴋᴀɴ ʙᴜɢ ᴋᴇᴘᴀᴅᴀ ᴏᴡɴᴇʀ, ᴊɪᴋᴀ ᴋᴇʙɪɴɢᴜɴɢᴀɴ ᴍᴇᴍᴀᴋᴀɪ ᴍᴇɴᴜ sɪʟᴀʜᴋᴀɴ ᴄʜᴀᴛ ᴏᴡɴᴇʀ',
  mentions: await conn.parseMention(tek),
  title: `${htki} *ʟɪsᴛ ᴍᴇɴᴜ* ${htka}`,
  buttonText: `ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴄʜᴏᴏsᴇ⎙`,
  sections
}
  if (teks == '404') {
  	return conn.sendMessage(m.chat, listMessage, { quoted: ftoko, contextInfo: { mentionedJid: [m.sender],
        externalAdReply: {
