...
`.trim()
    let c = wm
    let view = 'https://telegra.ph/file/a04a9cf01a1a628c30d3b.jpg'
    ...
    conn.reply(m.chat, confirm + '\n\n\nBalas Pesan Ini Sesuai Pilihan Anda\n• > jika Siap Balas Dengan ok\n• > Jika Tidak Siap Balas Dengan no', 0, {
        contextInfo: {
          ...
          externalAdReply: {
            ...
            thumbnail: await (await fetch(view)).buffer(),
            thumbnailUrl: view,
          },
        },
      })
...
handler.before = async m => {
    ...
    if (/(✔️|ok?)/g.test(m.text.toLowerCase())) {
