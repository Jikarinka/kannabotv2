...
async function handler(m, { Func, conn, args, usedPrefix, }) {
    ...
    try {
        ...
        if (!(m.sender in confirm)) {
            ...
            let txt = `Apakah anda yakin mau melakukan judi (ok/no)\n\n*Taruhan:* ${count} 💹\n⏰ 60s Timeout`
            let casino = 'https://telegra.ph/file/26163869708a74692c29a.jpg'
            //return conn.sendButton(m.chat, txt, author, null, [['✔️'], ['✖️']], m)
            return conn.reply(m.chat, txt + '\n\n\nBalas Pesan Ini Sesuai Pilihan Anda\n• > jika Siap Balas Dengan ok\n• > Jika Tidak Siap Balas Dengan no', 0, {
                contextInfo: {
                  ...
                  externalAdReply: {
                    ...
                    thumbnail: await (await fetch(casino)).buffer(),
                    thumbnailUrl: casino,
                  },
                },
              })
